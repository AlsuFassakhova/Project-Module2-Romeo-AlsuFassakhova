...
public class Deer extends Herbivorous{
    ...
    private String pathToJsonFile = Constants.pathToDeerJsonFile;

    public Deer(String icon, double maxWeight, int maxCountInTheLocation, int maxRangeToMove, double foodInKgToFull) {
        this.icon = icon;
